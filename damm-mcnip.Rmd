...
parRanges <- data.frame(min = c(50), max = c(100))
...
soilm <- rep(0.3369, length(times.def)) #ifelse(f$SoilM > 0.5, 0.5, f$SoilM)
...
mois <- approxfun(soilm, method = "linear", rule = 2) #create function for input data
