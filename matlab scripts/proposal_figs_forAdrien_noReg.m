...
brewcolor2 = [0 0 0];%[178/255 223/255 138/255];
brewcolor3 = [0 0 0];
...
set(gca,'FontSize',15)
legend({'Data','DAMM-MCNiP','DAMM'},'Location','northeast','FontSize',15);
...
set([xh,yh],'fontweight','bold');
set(gca,'FontSize',15)
legend({'1:1','DAMM-MCNiP','DAMM'},'Location','northeast','FontSize',15);
set(findall(gca, 'Type', 'Line'),'LineWidth',2);
xlim([0 3.5]);
ylim([0 3.5]);
