...
%set number of peaks
nopeaks = 4;
%fake pulse peak(s) 8 days long (192 hours, 50 up, 142 exp down)
insert1 = linspace(0.15,0.5,48/nopeaks);
insert2 = logspace(log10(0.5),log10(0.15),144/nopeaks);
insert = rep([insert1';insert2'],nopeaks);
area = trapz(insert);
